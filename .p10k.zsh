# Generated by Powerlevel10k configuration wizard on 2021-06-30 at 01:17 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    # virtualenv            # Python virtual environments - consider having on left side 
    # anaconda              # Conda virtual environments - consider having on left side
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=69
  ...
  typeset -g POWERLEVEL9K_ANACONDA_BACKGROUND=29
  ...
  # Google cloud color.
  typeset -g POWERLEVEL9K_GCLOUD_FOREGROUND=16
